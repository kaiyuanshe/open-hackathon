...
# oauth constants
QG_HOSTNAME = "http://osslab.msopentech.cn"
GITCAFE_HOSTNAME = "http://hackathon.chinacloudapp.cn"
...
Config = {
    ...
    "login": {
        "github": {
            "access_token_url": 'https://github.com/login/oauth/access_token?client_id=0eded406cf0b3f83b181&client_secret=3c81babd71d0cf60db3362261d42b4ce6b199538&redirect_uri=%s/github&code=' % QG_HOSTNAME,
            "user_info_url": 'https://api.github.com/user?access_token=',
            "emails_info_url": 'https://api.github.com/user/emails?access_token='
        },
        "qq": {
            "access_token_url": 'https://graph.qq.com/oauth2.0/token?grant_type=authorization_code&client_id=101157515&client_secret=018293bdbc15ddfc84306234aa34aa6c&redirect_uri=%s/qq&code=' % QG_HOSTNAME,
        ...
        "gitcafe": {
            "access_token_url": 'https://s.gitcafe.org/oauth/token?client_id=3c4db5b888e7cb35e6f580f9eb6777655f228a66d2beaaf361de3578b88fe46e&client_secret=e32af01fe52f5c57312b1ccca4bdead604bb6e6314f66a569a924b9ff6223d74&redirect_uri=%s/gitcafe&grant_type=authorization_code&code=' % GITCAFE_HOSTNAME
        },
    ...
    "javascript": {
        ...
        "qq": {
            ...
            "redirect_uri": "redirect_uri=%s/qq" % QG_HOSTNAME,
        ...
        "hackathon": {
            "endpoint": GITCAFE_HOSTNAME + ":15000",
            "qg_local_endpoint": QG_HOSTNAME,
            "gitcafe_endpoint": GITCAFE_HOSTNAME
        }
    }
}
